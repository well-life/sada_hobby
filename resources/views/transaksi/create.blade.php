            ...
            <div class="col-md-6">
                ...
                <form method="POST" action="laporan">
                    ...
                    <div class="p-3 mb-4 mt-3">
                        ...
                        <div class="mb-4">
                            <input id="nama_produk" class="form-control" type="text" name='nama_produk' value=""
                                required />
                        </div>
                        ...
                        <div class="mb-4">
                            <input id="total_produk" class="form-control" name='total_produk' value=""
                                required></textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            <input id="total_transaksi" class="form-control" name='total_transaksi' value=""
                                required></textarea>
                        </div>
                        <label for='tanggal' class="h6">Tanggal<span class='text-danger'>*</span></label>
                        <div class="mb-4">
                            <input id="tanggal" class="form-control" type="date" name='tanggal' value=""
                                required />
                        </div>
                        <p></p>
                        <div class="mt-4">
